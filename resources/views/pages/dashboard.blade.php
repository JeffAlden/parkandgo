                ...
                <div class="card ">
                    <div class="card-header pb-0 p-3">
                        <div class="d-flex justify-content-between">
                            <h6 class="mb-2">Sales by Location</h6>
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td class="w-30">
                                        <div class="d-flex px-2 py-1 align-items-center">
                                            ...
                                            <div class="ms-4">
                                                ...
                                                <h6 class="text-sm mb-0">Park and Go Carmona</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            ...
                                            <h6 class="text-sm mb-0">₱30,900</h6>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td class="w-30">
                                        <div class="d-flex px-2 py-1 align-items-center">
                                            ...
                                            <div class="ms-4">
                                                <p class="text-xs font-weight-bold mb-0">Branch:</p>
                                                <h6 class="text-sm mb-0">Park and Go Makati</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="w-30">
                                        <div class="d-flex px-2 py-1 align-items-center">
                                            ...
                                            <div class="ms-4">
                                                <p class="text-xs font-weight-bold mb-0">Branch:</p>
                                                <h6 class="text-sm mb-0">Park and Go BGC</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="w-30">
                                        <div class="d-flex px-2 py-1 align-items-center">
                                            ...
                                            <div class="ms-4">
                                                <p class="text-xs font-weight-bold mb-0">Branch:</p>
                                                <h6 class="text-sm mb-0">Park and Go Laguna</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
