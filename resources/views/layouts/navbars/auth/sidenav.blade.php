<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}" target="_blank">
            ...
            <span class="ms-4 font-weight-bold">Park and Go</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'vehicles.index' ? 'active' : '' }}"
                    href="{{ route('vehicles.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bus-front-12 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Parked Fleet Overview</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'getCheckedOutVehicles' ? 'active' : '' }}"
                    href="{{ route('getCheckedOutVehicles') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-delivery-fast text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Checked Out Vehicles</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'showReportGenerator' ? 'active' : '' }}"
                    href="{{ route('showReportGenerator') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!--  Income Generator here -->
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'income-report' ? 'active' : '' }}"
                    href="{{ route('income-report') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-money-coins text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Income Generator</span>
                </a>
            </li>
